  ...
  public:
    ...
    class FieldsIter
    {
      public:
       ...
       bool operator!=(const FieldsIter& other) { return (other.m_ptr != m_ptr || other.m_idx != m_idx); }
       template<typename T=void>
       const T* operator*() const { return m_ptr->get_field_ptr_for_query_idx<T>(m_idx); }
       const FieldsIter& operator++()
       {
         ++m_idx;
         return *this;
       }
