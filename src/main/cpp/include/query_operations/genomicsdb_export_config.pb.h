...
class ColumnRangeListDefaultTypeInternal;
extern ColumnRangeListDefaultTypeInternal _ColumnRangeList_default_instance_;
class ExportConfiguration;
class ExportConfigurationDefaultTypeInternal;
extern ExportConfigurationDefaultTypeInternal _ExportConfiguration_default_instance_;
...
class ColumnRange : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ColumnRange) */ {
 ...
 private:
  ...
  friend struct  protobuf_genomicsdb_5fexport_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class ColumnRangeList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ColumnRangeList) */ {
 public:
  ...
  static inline const ColumnRangeList* internal_default_instance() {
    return reinterpret_cast<const ColumnRangeList*>(
  ...
  inline ColumnRangeList* New() const PROTOBUF_FINAL { return New(NULL); }

  ColumnRangeList* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class ExportConfiguration : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ExportConfiguration) */ {
 public:
  ...
  static inline const ExportConfiguration* internal_default_instance() {
    return reinterpret_cast<const ExportConfiguration*>(
  ...
  inline ExportConfiguration* New() const PROTOBUF_FINAL { return New(NULL); }

  ExportConfiguration* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  #if LANG_CXX11
  void set_reference_genome(::std::string&& value);
  #endif
 ...
 private:
  ...
  void set_has_reference_genome();
  void clear_has_reference_genome();
...
#if LANG_CXX11
inline void ExportConfiguration::set_tiledb_workspace(::std::string&& value) {
  set_has_tiledb_workspace();
...
#if LANG_CXX11
inline void ExportConfiguration::set_tiledb_array_name(::std::string&& value) {
  set_has_tiledb_array_name();
...
#if LANG_CXX11
inline void ExportConfiguration::set_reference_genome(::std::string&& value) {
  set_has_reference_genome();
...
#if LANG_CXX11
inline void ExportConfiguration::set_attributes(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:ExportConfiguration.attributes)
...
#if LANG_CXX11
inline void ExportConfiguration::add_attributes(::std::string&& value) {
