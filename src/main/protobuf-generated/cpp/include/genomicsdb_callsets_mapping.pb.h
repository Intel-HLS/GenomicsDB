...
class SampleIDToTileDBIDMap : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SampleIDToTileDBIDMap) */ {
 public:
  ...
  ::google::protobuf::int64 idx_in_file() const;
  void set_idx_in_file(::google::protobuf::int64 value);
 ...
 private:
  ...
  ::google::protobuf::int64 idx_in_file_;
...
inline ::google::protobuf::int64 SampleIDToTileDBIDMap::idx_in_file() const {
  // @@protoc_insertion_point(field_get:SampleIDToTileDBIDMap.idx_in_file)
  return idx_in_file_;
}
inline void SampleIDToTileDBIDMap::set_idx_in_file(::google::protobuf::int64 value) {
  set_has_idx_in_file();
  idx_in_file_ = value;
